...
public class CourseRegister extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/studentcourse/icons8_study_40px.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            double courseFee = Double.parseDouble(jTextField3.getText());
            int studentID = Integer.parseInt(jTextField1.getText());
            String courseName  = jTextField2.getText();
            String query = "insert into course_fee values ('"+studentID+"','"+courseName+"','"+courseFee+"')";
            stmt.execute(query);
            query = "update student_balance  set balance = balance - "+courseFee+" where student_id = "+studentID;
            ...
            JOptionPane.showMessageDialog(this, "An error occured while registering! try again. ");
        }
        try {
            con.rollback();
            con.close();
